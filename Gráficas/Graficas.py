...
lendaDatos = ['11/22', '12/13', '13/14', '14/15', '15/16', '16/17', '17/18',
...
graficoBarras.x = 50
graficoBarras.y = 50
graficoBarras.width = 125
graficoBarras.height = 300
...
graficoBarras.groupSpacing = 5

d.add(graficoBarras)
doc = SimpleDocTemplate("EjemploGráficos.pdf", pagesize=A4)
doc.build([d])